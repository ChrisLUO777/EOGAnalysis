    ...
    if(subcombs(k,1)~=subcombs(k,2))
        for i=1:10
            ...
            for j=1:10
                ...
                [h,p] = kstest2(abshpdf1,abshpdf2);
                EOGfixtestset(count,1)=p;
                [h,p] = kstest2(absvpdf1,absvpdf2);
                EOGfixtestset(count,2)=p;
                [h,p] = kstest2(deri1hpdf1,deri1hpdf2);
                EOGfixtestset(count,3)=p;
                [h,p] = kstest2(deri1vpdf1,deri1vpdf2);
                EOGfixtestset(count,4)=p;
                [h,p] = kstest2(deri2hpdf1,deri2hpdf2);
                EOGfixtestset(count,5)=p;
                [h,p] = kstest2(deri2vpdf1,deri2vpdf2);
                EOGfixtestset(count,6)=p;
                [h,p] = kstest2(fixdurationhpdf1,fixdurationhpdf2);
                EOGfixtestset(count,7)=p;
                [h,p] = kstest2(fixdurationvpdf1,fixdurationvpdf2);
                EOGfixtestset(count,8)=p;
                [h,p] = kstest2(fixstarthpdf1,fixstarthpdf2);
                EOGfixtestset(count,9)=p;
                [h,p] = kstest2(fixstartvpdf1,fixstartvpdf2);
                EOGfixtestset(count,10)=p;
                [h,p] = kstest2(maxhpdf1,maxhpdf2);
                EOGfixtestset(count,11)=p;
                [h,p] = kstest2(maxvpdf1,maxvpdf2);
                EOGfixtestset(count,12)=p;
                [h,p] = kstest2(meanhpdf1,meanhpdf2);
                EOGfixtestset(count,13)=p;
                [h,p] = kstest2(meanvpdf1,meanvpdf2);
                EOGfixtestset(count,14)=p;
                [h,p] = kstest2(minhpdf1,minhpdf2);
                EOGfixtestset(count,15)=p;
                [h,p] = kstest2(minvpdf1,minvpdf2);
                EOGfixtestset(count,16)=p;
                [h,p] = kstest2(sacamplitudehpdf1,sacamplitudehpdf2);
                EOGfixtestset(count,17)=p;
                [h,p] = kstest2(sacamplitudevpdf1,sacamplitudevpdf2);
                EOGfixtestset(count,18)=p;
                [h,p] = kstest2(sacdurationhpdf1,sacdurationhpdf2);
                EOGfixtestset(count,19)=p;
                [h,p] = kstest2(sacdurationvpdf1,sacdurationvpdf2);
                EOGfixtestset(count,20)=p;
                [h,p] = kstest2(sacstarthpdf1,sacstarthpdf2);
                EOGfixtestset(count,21)=p;
                [h,p] = kstest2(sacstartvpdf1,sacstartvpdf2);
                EOGfixtestset(count,22)=p;
                [h,p] = kstest2(blinkstartpdf1,blinkstartpdf2);
                EOGfixtestset(count,23)=p;
                [h,p] = kstest2(blinkdurationpdf1,blinkdurationpdf2);
                EOGfixtestset(count,24)=p;
                [h,p] = kstest2(fixcentroidhpdf1,fixcentroidhpdf2);
                EOGfixtestset(count,25)=p;
                [h,p] = kstest2(fixcentroidvpdf1,fixcentroidvpdf2);
                EOGfixtestset(count,26)=p;
                
                [h,p] = kstest2(maxdistancehpdf1,maxdistancehpdf2);
                EOGfixtestset(count,27)=p;
                [h,p] = kstest2(maxdistancevpdf1,maxdistancevpdf2);
                EOGfixtestset(count,28)=p;
                [h,p] = kstest2(mindistancehpdf1,mindistancehpdf2);
                EOGfixtestset(count,29)=p;
                [h,p] = kstest2(mindistancevpdf1,mindistancevpdf2);
                EOGfixtestset(count,30)=p;
                [h,p] = kstest2(slopeophpdf1,slopeophpdf2);
                EOGfixtestset(count,31)=p;
                [h,p] = kstest2(slopeopvpdf1,slopeopvpdf2);
                EOGfixtestset(count,32)=p;
                [h,p] = kstest2(slopefphpdf1,slopefphpdf2);
                EOGfixtestset(count,33)=p;
                [h,p] = kstest2(slopefpvpdf1,slopefpvpdf2);
                EOGfixtestset(count,34)=p;
                [h,p] = kstest2(slopeonhpdf1,slopeonhpdf2);
                EOGfixtestset(count,35)=p;
                [h,p] = kstest2(slopeonvpdf1,slopeonvpdf2);
                EOGfixtestset(count,36)=p;
                [h,p] = kstest2(slopefnhpdf1,slopefnhpdf2);
                EOGfixtestset(count,37)=p;
                [h,p] = kstest2(slopefnvpdf1,slopefnvpdf2);
                EOGfixtestset(count,38)=p;
                [h,p] = kstest2(maxderihpdf1,maxderihpdf2);
                EOGfixtestset(count,39)=p;
                [h,p] = kstest2(maxderivpdf1,maxderivpdf2);
                EOGfixtestset(count,40)=p;
                [h,p] = kstest2(minderihpdf1,minderihpdf2);
                EOGfixtestset(count,41)=p;
                [h,p] = kstest2(minderivpdf1,minderivpdf2);
                EOGfixtestset(count,42)=p;
                [h,p] = kstest2(maxderidistancehpdf1,maxderidistancehpdf2);
                EOGfixtestset(count,43)=p;
                [h,p] = kstest2(maxderidistancevpdf1,maxderidistancevpdf2);
                EOGfixtestset(count,44)=p;
                [h,p] = kstest2(minderidistancehpdf1,minderidistancehpdf2);
                EOGfixtestset(count,45)=p;
                [h,p] = kstest2(minderidistancevpdf1,minderidistancevpdf2);
