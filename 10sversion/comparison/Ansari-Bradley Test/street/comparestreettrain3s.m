    ...
    if(subcombs(k,1)~=subcombs(k,2))
        for i=1:10
            ...
            for j=1:10
                ...
                [~,cm_P,~] = ansaribradley(abshpdf1,abshpdf2);
                EOGstreettrainset(count,1)=cm_P;
                [~,cm_P,~] = ansaribradley(absvpdf1,absvpdf2);
                EOGstreettrainset(count,2)=cm_P;
                [~,cm_P,~] = ansaribradley(deri1hpdf1,deri1hpdf2);
                EOGstreettrainset(count,3)=cm_P;
                [~,cm_P,~] = ansaribradley(deri1vpdf1,deri1vpdf2);
                EOGstreettrainset(count,4)=cm_P;
                [~,cm_P,~] = ansaribradley(deri2hpdf1,deri2hpdf2);
                EOGstreettrainset(count,5)=cm_P;
                [~,cm_P,~] = ansaribradley(deri2vpdf1,deri2vpdf2);
                EOGstreettrainset(count,6)=cm_P;
                [~,cm_P,~] = ansaribradley(fixdurationhpdf1,fixdurationhpdf2);
                EOGstreettrainset(count,7)=cm_P;
                [~,cm_P,~] = ansaribradley(fixdurationvpdf1,fixdurationvpdf2);
                EOGstreettrainset(count,8)=cm_P;
                [~,cm_P,~] = ansaribradley(fixstarthpdf1,fixstarthpdf2);
                EOGstreettrainset(count,9)=cm_P;
                [~,cm_P,~] = ansaribradley(fixstartvpdf1,fixstartvpdf2);
                EOGstreettrainset(count,10)=cm_P;
                [~,cm_P,~] = ansaribradley(maxhpdf1,maxhpdf2);
                EOGstreettrainset(count,11)=cm_P;
                [~,cm_P,~] = ansaribradley(maxvpdf1,maxvpdf2);
                EOGstreettrainset(count,12)=cm_P;
                [~,cm_P,~] = ansaribradley(meanhpdf1,meanhpdf2);
                EOGstreettrainset(count,13)=cm_P;
                [~,cm_P,~] = ansaribradley(meanvpdf1,meanvpdf2);
                EOGstreettrainset(count,14)=cm_P;
                [~,cm_P,~] = ansaribradley(minhpdf1,minhpdf2);
                EOGstreettrainset(count,15)=cm_P;
                [~,cm_P,~] = ansaribradley(minvpdf1,minvpdf2);
                EOGstreettrainset(count,16)=cm_P;
                [~,cm_P,~] = ansaribradley(sacamplitudehpdf1,sacamplitudehpdf2);
                EOGstreettrainset(count,17)=cm_P;
                [~,cm_P,~] = ansaribradley(sacamplitudevpdf1,sacamplitudevpdf2);
                EOGstreettrainset(count,18)=cm_P;
                [~,cm_P,~] = ansaribradley(sacdurationhpdf1,sacdurationhpdf2);
                EOGstreettrainset(count,19)=cm_P;
                [~,cm_P,~] = ansaribradley(sacdurationvpdf1,sacdurationvpdf2);
                EOGstreettrainset(count,20)=cm_P;
                [~,cm_P,~] = ansaribradley(sacstarthpdf1,sacstarthpdf2);
                EOGstreettrainset(count,21)=cm_P;
                [~,cm_P,~] = ansaribradley(sacstartvpdf1,sacstartvpdf2);
                EOGstreettrainset(count,22)=cm_P;
                [~,cm_P,~] = ansaribradley(blinkstartpdf1,blinkstartpdf2);
                EOGstreettrainset(count,23)=cm_P;
                [~,cm_P,~] = ansaribradley(blinkdurationpdf1,blinkdurationpdf2);
                EOGstreettrainset(count,24)=cm_P;
                [~,cm_P,~] = ansaribradley(fixcentroidhpdf1,fixcentroidhpdf2);
                EOGstreettrainset(count,25)=cm_P;
                [~,cm_P,~] = ansaribradley(fixcentroidvpdf1,fixcentroidvpdf2);
                EOGstreettrainset(count,26)=cm_P;
                
                [~,cm_P,~] = ansaribradley(maxdistancehpdf1,maxdistancehpdf2);
                EOGstreettrainset(count,27)=cm_P;
                [~,cm_P,~] = ansaribradley(maxdistancevpdf1,maxdistancevpdf2);
                EOGstreettrainset(count,28)=cm_P;
                [~,cm_P,~] = ansaribradley(mindistancehpdf1,mindistancehpdf2);
                EOGstreettrainset(count,29)=cm_P;
                [~,cm_P,~] = ansaribradley(mindistancevpdf1,mindistancevpdf2);
                EOGstreettrainset(count,30)=cm_P;
                [~,cm_P,~] = ansaribradley(slopeophpdf1,slopeophpdf2);
                EOGstreettrainset(count,31)=cm_P;
                [~,cm_P,~] = ansaribradley(slopeopvpdf1,slopeopvpdf2);
                EOGstreettrainset(count,32)=cm_P;
                [~,cm_P,~] = ansaribradley(slopefphpdf1,slopefphpdf2);
                EOGstreettrainset(count,33)=cm_P;
                [~,cm_P,~] = ansaribradley(slopefpvpdf1,slopefpvpdf2);
                EOGstreettrainset(count,34)=cm_P;
                [~,cm_P,~] = ansaribradley(slopeonhpdf1,slopeonhpdf2);
                EOGstreettrainset(count,35)=cm_P;
                [~,cm_P,~] = ansaribradley(slopeonvpdf1,slopeonvpdf2);
                EOGstreettrainset(count,36)=cm_P;
                [~,cm_P,~] = ansaribradley(slopefnhpdf1,slopefnhpdf2);
                EOGstreettrainset(count,37)=cm_P;
                [~,cm_P,~] = ansaribradley(slopefnvpdf1,slopefnvpdf2);
                EOGstreettrainset(count,38)=cm_P;
                [~,cm_P,~] = ansaribradley(maxderihpdf1,maxderihpdf2);
                EOGstreettrainset(count,39)=cm_P;
                [~,cm_P,~] = ansaribradley(maxderivpdf1,maxderivpdf2);
                EOGstreettrainset(count,40)=cm_P;
                [~,cm_P,~] = ansaribradley(minderihpdf1,minderihpdf2);
                EOGstreettrainset(count,41)=cm_P;
                [~,cm_P,~] = ansaribradley(minderivpdf1,minderivpdf2);
                EOGstreettrainset(count,42)=cm_P;
                [~,cm_P,~] = ansaribradley(maxderidistancehpdf1,maxderidistancehpdf2);
                EOGstreettrainset(count,43)=cm_P;
                [~,cm_P,~] = ansaribradley(maxderidistancevpdf1,maxderidistancevpdf2);
                EOGstreettrainset(count,44)=cm_P;
                [~,cm_P,~] = ansaribradley(minderidistancehpdf1,minderidistancehpdf2);
                EOGstreettrainset(count,45)=cm_P;
                [~,cm_P,~] = ansaribradley(minderidistancevpdf1,minderidistancevpdf2);
