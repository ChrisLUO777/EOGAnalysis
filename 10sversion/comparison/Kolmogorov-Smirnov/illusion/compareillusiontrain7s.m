    ...
    if(subcombs(k,1)~=subcombs(k,2))
        for i=1:10
            ...
            for j=1:10
                ...
                [~,p] = kstest2(abshpdf1,abshpdf2);
                EOGillusiontrainset(count,1)=p;
                [~,p] = kstest2(absvpdf1,absvpdf2);
                EOGillusiontrainset(count,2)=p;
                [~,p] = kstest2(deri1hpdf1,deri1hpdf2);
                EOGillusiontrainset(count,3)=p;
                [~,p] = kstest2(deri1vpdf1,deri1vpdf2);
                EOGillusiontrainset(count,4)=p;
                [~,p] = kstest2(deri2hpdf1,deri2hpdf2);
                EOGillusiontrainset(count,5)=p;
                [~,p] = kstest2(deri2vpdf1,deri2vpdf2);
                EOGillusiontrainset(count,6)=p;
                [~,p] = kstest2(fixdurationhpdf1,fixdurationhpdf2);
                EOGillusiontrainset(count,7)=p;
                [~,p] = kstest2(fixdurationvpdf1,fixdurationvpdf2);
                EOGillusiontrainset(count,8)=p;
                [~,p] = kstest2(fixstarthpdf1,fixstarthpdf2);
                EOGillusiontrainset(count,9)=p;
                [~,p] = kstest2(fixstartvpdf1,fixstartvpdf2);
                EOGillusiontrainset(count,10)=p;
                [~,p] = kstest2(maxhpdf1,maxhpdf2);
                EOGillusiontrainset(count,11)=p;
                [~,p] = kstest2(maxvpdf1,maxvpdf2);
                EOGillusiontrainset(count,12)=p;
                [~,p] = kstest2(meanhpdf1,meanhpdf2);
                EOGillusiontrainset(count,13)=p;
                [~,p] = kstest2(meanvpdf1,meanvpdf2);
                EOGillusiontrainset(count,14)=p;
                [~,p] = kstest2(minhpdf1,minhpdf2);
                EOGillusiontrainset(count,15)=p;
                [~,p] = kstest2(minvpdf1,minvpdf2);
                EOGillusiontrainset(count,16)=p;
                [~,p] = kstest2(sacamplitudehpdf1,sacamplitudehpdf2);
                EOGillusiontrainset(count,17)=p;
                [~,p] = kstest2(sacamplitudevpdf1,sacamplitudevpdf2);
                EOGillusiontrainset(count,18)=p;
                [~,p] = kstest2(sacdurationhpdf1,sacdurationhpdf2);
                EOGillusiontrainset(count,19)=p;
                [~,p] = kstest2(sacdurationvpdf1,sacdurationvpdf2);
                EOGillusiontrainset(count,20)=p;
                [~,p] = kstest2(sacstarthpdf1,sacstarthpdf2);
                EOGillusiontrainset(count,21)=p;
                [~,p] = kstest2(sacstartvpdf1,sacstartvpdf2);
                EOGillusiontrainset(count,22)=p;
                [~,p] = kstest2(blinkstartpdf1,blinkstartpdf2);
                EOGillusiontrainset(count,23)=p;
                [~,p] = kstest2(blinkdurationpdf1,blinkdurationpdf2);
                EOGillusiontrainset(count,24)=p;
                [~,p] = kstest2(fixcentroidhpdf1,fixcentroidhpdf2);
                EOGillusiontrainset(count,25)=p;
                [~,p] = kstest2(fixcentroidvpdf1,fixcentroidvpdf2);
                EOGillusiontrainset(count,26)=p;
                
                [~,p] = kstest2(maxdistancehpdf1,maxdistancehpdf2);
                EOGillusiontrainset(count,27)=p;
                [~,p] = kstest2(maxdistancevpdf1,maxdistancevpdf2);
                EOGillusiontrainset(count,28)=p;
                [~,p] = kstest2(mindistancehpdf1,mindistancehpdf2);
                EOGillusiontrainset(count,29)=p;
                [~,p] = kstest2(mindistancevpdf1,mindistancevpdf2);
                EOGillusiontrainset(count,30)=p;
                [~,p] = kstest2(slopeophpdf1,slopeophpdf2);
                EOGillusiontrainset(count,31)=p;
                [~,p] = kstest2(slopeopvpdf1,slopeopvpdf2);
                EOGillusiontrainset(count,32)=p;
                [~,p] = kstest2(slopefphpdf1,slopefphpdf2);
                EOGillusiontrainset(count,33)=p;
                [~,p] = kstest2(slopefpvpdf1,slopefpvpdf2);
                EOGillusiontrainset(count,34)=p;
                [~,p] = kstest2(slopeonhpdf1,slopeonhpdf2);
                EOGillusiontrainset(count,35)=p;
                [~,p] = kstest2(slopeonvpdf1,slopeonvpdf2);
                EOGillusiontrainset(count,36)=p;
                [~,p] = kstest2(slopefnhpdf1,slopefnhpdf2);
                EOGillusiontrainset(count,37)=p;
                [~,p] = kstest2(slopefnvpdf1,slopefnvpdf2);
                EOGillusiontrainset(count,38)=p;
                [~,p] = kstest2(maxderihpdf1,maxderihpdf2);
                EOGillusiontrainset(count,39)=p;
                [~,p] = kstest2(maxderivpdf1,maxderivpdf2);
                EOGillusiontrainset(count,40)=p;
                [~,p] = kstest2(minderihpdf1,minderihpdf2);
                EOGillusiontrainset(count,41)=p;
                [~,p] = kstest2(minderivpdf1,minderivpdf2);
                EOGillusiontrainset(count,42)=p;
                [~,p] = kstest2(maxderidistancehpdf1,maxderidistancehpdf2);
                EOGillusiontrainset(count,43)=p;
                [~,p] = kstest2(maxderidistancevpdf1,maxderidistancevpdf2);
                EOGillusiontrainset(count,44)=p;
                [~,p] = kstest2(minderidistancehpdf1,minderidistancehpdf2);
                EOGillusiontrainset(count,45)=p;
                [~,p] = kstest2(minderidistancevpdf1,minderidistancevpdf2);
