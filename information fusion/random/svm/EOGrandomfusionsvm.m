close all; clear;
load("EOGrandomtrainset.mat");
load("EOGrandomcvset.mat");
load("EOGrandomtestset.mat");
X=EOGrandomtrainset(:,1:24);
y=EOGrandomtrainset(:,25);
m = size(X, 1);
Xval=EOGrandomcvset(:,1:24);
yval=EOGrandomcvset(:,25);
mval=size(Xval,1);
Xtest=EOGrandomtestset(:,1:24);
ytest=EOGrandomtestset(:,25);
mtest=size(Xtest,1);
