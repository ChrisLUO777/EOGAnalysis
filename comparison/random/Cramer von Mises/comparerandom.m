...
for k=1:size(subcombs,1)
    path1="EOG"+subcombs(k,1)+"random";
    path2="EOG"+subcombs(k,2)+"random";
    type="random";
    ...
    save("EOG"+type+"wholeset.mat",'EOGrandomwholeset');
end
